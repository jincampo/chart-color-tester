...
class ChartColorTester {
    constructor() {
        ...
        this.presets = {
            ...
            'nature-spectrum': {
                standard: ['#6574B6', '#6BAF9E', '#CC6C6C', '#E3CA6D', '#2E6E68', '#9B9B9B', '#E8B295', '#7E6FAF', '#6E9FCF', '#4E6B54'],
                standardDark: ['#8591D0', '#8BC5B8', '#D68989', '#E9D58A', '#4B8B85', '#B5B5B5', '#EBC5B2', '#9B8BC5', '#8BB5E2', '#6B8571'],
                light: ['#A5AEE0', '#A8D5C8', '#DDA6A6', '#EFE0A7', '#6BA8A2', '#CFCFCF', '#F0D8C2', '#B8A8D5', '#A8C5E8', '#88A291'],
                lightDark: ['#505D92', '#528A7E', '#A55252', '#C4A853', '#225450', '#787878', '#C59578', '#644F8A', '#5680A2', '#3A5240'],
                funnel: {
                    continued: ['#6574B6', '#6BAF9E', '#CC6C6C', '#E3CA6D', '#2E6E68', '#9B9B9B', '#E8B295', '#7E6FAF', '#6E9FCF', '#4E6B54'],
                    dropped: ['#A5AEE0', '#A8D5C8', '#DDA6A6', '#EFE0A7', '#6BA8A2', '#CFCFCF', '#F0D8C2', '#B8A8D5', '#A8C5E8', '#88A291'],
                    hover: ['#505D92', '#528A7E', '#A55252', '#C4A853', '#225450', '#787878', '#C59578', '#644F8A', '#5680A2', '#3A5240'],
                    selected: ['#3C466E', '#3E6B5E', '#833E3E', '#9B853F', '#1A403C', '#5A5A5A', '#9E7459', '#4C3B6B', '#42607A', '#2A3E30']
                }
            }
        };
